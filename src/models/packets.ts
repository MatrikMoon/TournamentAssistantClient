...
import { ReplayStreamPacket } from './replay_stream.js';
...
export interface Packet {
    ...
    packet: {
        ...
        /**
         * @generated from protobuf field: proto.replay.ReplayStreamPacket replay_stream = 12
         */
        replayStream: ReplayStreamPacket;
    } | {
        oneofKind: undefined;
    };
}
...
class Packet$Type extends MessageType<Packet> {
    constructor() {
        super("proto.packets.Packet", [
            ...
            { no: 12, name: "replay_stream", kind: "message", oneof: "packet", T: () => ReplayStreamPacket }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* proto.packets.Event event */ 10:
                    ...
                    break;
                case /* proto.replay.ReplayStreamPacket replay_stream */ 12:
                    message.packet = {
                        oneofKind: "replayStream",
                        replayStream: ReplayStreamPacket.internalBinaryRead(reader, reader.uint32(), options, (message.packet as any).replayStream)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Packet, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.replay.ReplayStreamPacket replay_stream = 12; */
        if (message.packet.oneofKind === "replayStream")
            ReplayStreamPacket.internalBinaryWrite(message.packet.replayStream, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
