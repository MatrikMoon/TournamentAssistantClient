...
class PlayerSpecificSettings$Type extends MessageType<PlayerSpecificSettings> {
    ...
    create(value?: PartialMessage<PlayerSpecificSettings>): PlayerSpecificSettings {
        ...
        message.sfxVolume = 0;
        message.saberTrailIntensity = 0;
        message.noteJumpStartBeatOffset = 0;
        message.noteJumpFixedDuration = 0;
        message.options = 0;
        message.noteJumpDurationTypeSettings = 0;
        message.arcVisibilityType = 0;
        if (value !== undefined)
...
class GameplayParameters$Type extends MessageType<GameplayParameters> {
    ...
    create(value?: PartialMessage<GameplayParameters>): GameplayParameters {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.attempts = 0;
        message.showScoreboard = false;
        message.disablePause = false;
        message.disableFail = false;
        message.disableScoresaberSubmission = false;
        message.disableCustomNotesOnStream = false;
        message.useSync = false;
        message.target = 0;
        if (value !== undefined)
...
class Tournament$Type extends MessageType<Tournament> {
    constructor() {
        super("proto.models.Tournament", [
            ...
            { no: 4, name: "matches", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Match },
            { no: 5, name: "qualifiers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QualifierEvent },
...
class Tournament_TournamentSettings$Type extends MessageType<Tournament_TournamentSettings> {
    constructor() {
        super("proto.models.Tournament.TournamentSettings", [
            ...
            { no: 5, name: "teams", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Tournament_TournamentSettings_Team },
            ...
            { no: 8, name: "pools", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Tournament_TournamentSettings_Pool },
...
class Tournament_TournamentSettings_Pool$Type extends MessageType<Tournament_TournamentSettings_Pool> {
    constructor() {
        super("proto.models.Tournament.TournamentSettings.Pool", [
            ...
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "image", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "maps", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Map }
        ]);
    }
...
class State$Type extends MessageType<State> {
    constructor() {
        super("proto.models.State", [
            { no: 1, name: "tournaments", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Tournament },
            { no: 2, name: "known_servers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CoreServer }
        ]);
    }
...
class LeaderboardEntry$Type extends MessageType<LeaderboardEntry> {
    ...
    create(value?: PartialMessage<LeaderboardEntry>): LeaderboardEntry {
        ...
        message.platformId = "";
        message.username = "";
        message.multipliedScore = 0;
        message.modifiedScore = 0;
        message.maxPossibleScore = 0;
        message.accuracy = 0;
        message.notesMissed = 0;
        message.badCuts = 0;
        message.goodCuts = 0;
        message.maxCombo = 0;
...
class RealtimeScore$Type extends MessageType<RealtimeScore> {
    ...
    create(value?: PartialMessage<RealtimeScore>): RealtimeScore {
        ...
        message.userGuid = "";
        message.score = 0;
        message.scoreWithModifiers = 0;
        message.maxScore = 0;
        message.maxScoreWithModifiers = 0;
        message.combo = 0;
        message.playerHealth = 0;
        message.accuracy = 0;
        message.songPosition = 0;
        message.notesMissed = 0;
        message.badCuts = 0;
        message.bombHits = 0;
        message.wallHits = 0;
